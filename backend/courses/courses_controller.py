...
@jwt_required()
def review_course_enrollment(enrollment_id):
    try:
        data = request.get_json() or {}
        success, msg, code = courses_model.review_course_enrollment(
...
@courses_bp.route('/payment-screenshot/<filename>', methods=['GET'])
