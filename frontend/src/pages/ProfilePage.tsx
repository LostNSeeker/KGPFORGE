...
export const ProfilePage: React.FC = () => {
  ...
  const isFounderTrackRole = ['alumni', 'founder', 'mentor', 'investor'].includes(currentProfile.role)
  ...
  return (
    <div className="min-h-screen bg-[#f4f2ee] pt-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="relative">
                ...
                <div className="absolute -bottom-2 -right-2">
                  ...
                  >
                    <div className="rounded-full h-8 w-8 p-0 bg-white text-blue-700 hover:bg-gray-100 flex items-center justify-center shadow-md border border-gray-200">
                      {uploadingPicture ? (
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600 mb-4">{currentProfile.email}</p>
                <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                  <Badge variant="secondary" className="bg-gray-100 text-gray-800 border-gray-200">
                    {roleLabelMap[currentProfile.role] || 'User'}
                  </Badge>
                  ...
                  {isFounderTrackRole && currentProfile.is_available !== undefined && (
                    <Badge 
                      variant="secondary" 
              ...
              <div className="flex gap-2">
                {!editing ? (
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" onClick={handleCancel} className="bg-white text-gray-800 border-gray-300 hover:bg-gray-100">
