            ...
            {featuredEvent && (
                <section className="py-20 bg-gradient-to-br from-[#0f0a1f] via-[#1a1033] to-[#0f0a1f] relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 opacity-30">
                        <img 
                            src={resolveImageUrl(featuredEvent.image_url, "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1200")} 
                            alt="" 
                                ...
                                >
                                    <Card className="h-full flex flex-col hover:shadow-xl transition-all duration-300 overflow-hidden border-0 shadow-md bg-white group">
                                        <div className="relative h-48 w-full overflow-hidden">
                                            <img 
                                                src={resolveImageUrl(event.image_url, 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800')} 
                                                alt={event.title}
                                        ...
                                        <CardContent className="flex-1 pt-4">
                                            ...
                                            {event.speaker_name && (
                                                <div className="flex items-center gap-3 mt-4 pt-4 border-t">
                                                    <img 
                                                        src={resolveImageUrl(event.speaker_image, `https://ui-avatars.com/api/?name=${encodeURIComponent(event.speaker_name)}&background=7c3aed&color=fff`)}
                        ...
                        {events.slice(0, 4).filter(e => e.speaker_name).map((event, i) => (
                            <div key={i} className="text-center group">
                                <div className="relative mb-4 overflow-hidden rounded-xl">
                                    <img 
                                        src={resolveImageUrl(event.speaker_image, `https://images.unsplash.com/photo-150${i}011347-78bfbfbd5f${24 + i}?w=300`)}
                                        alt={event.speaker_name}
