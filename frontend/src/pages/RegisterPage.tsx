...
export const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (formData.role !== 'student' && (!formData.graduationYear || !formData.department)) {
      setError('Please provide graduation year and department for alumni role registration')
      return
    }
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {formData.role !== 'student' && (
                <Alert>
                  <AlertDescription>
                    Your account will need admin approval after signup. Please wait, we will contact you soon.
                  </AlertDescription>
                </Alert>
              )}
